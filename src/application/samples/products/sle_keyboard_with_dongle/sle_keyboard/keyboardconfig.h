...
// #define CONFIG_KEYSCAN_ENABLE_ROW 12
// #define CONFIG_KEYSCAN_ENABLE_COL 7

#define KEYSCAN_MAP                                                                                                    \
    {                                                                                                                  \
        {HID_KEY_F11,        HID_KEY_F12,         HID_KEY_6,       HID_KEY_PAGE_DOWN,                                  \
         HID_KEY_APOSTROPHE, HID_KEY_RIGHT_ARROW, HID_KEY_SPACEBAR},                                                   \
            {HID_KEY_F10,       HID_KEY_PRINT_SCREEN, HID_KEY_5,       HID_KEY_ENTER,                                  \
             HID_KEY_SEMICOLON, HID_KEY_DOWN_ARROW,   HID_KEY_ALT_LEFT},                                               \
            {HID_KEY_F9, HID_KEY_PAUSE, HID_KEY_4, HID_KEY_PAGE_UP, HID_KEY_L, HID_KEY_LEFT_ARROW, HID_KEY_GUI_LEFT},  \
            {HID_KEY_F8, HID_KEY_DELETE,     HID_KEY_3,        HID_KEY_BACKSLASH,                                      \
             HID_KEY_K,  HID_KEY_CTRL_RIGHT, HID_KEY_CTRL_LEFT},                                                       \
            {HID_KEY_F7, HID_KEY_HOME, HID_KEY_2, HID_KEY_RIGHT_BRACKET, HID_KEY_J, HID_KEY_FN, HID_KEY_M},            \
            {HID_KEY_F6, HID_KEY_BACKSPACE, HID_KEY_1, HID_KEY_LEFT_BRACKET, HID_KEY_H, HID_KEY_ALT_RIGHT, HID_KEY_N}, \
            {HID_KEY_F5, HID_KEY_EQUALS, HID_KEY_GRAVE_ACCENT, HID_KEY_P, HID_KEY_G, HID_KEY_END, HID_KEY_B},          \
            {HID_KEY_F4, HID_KEY_MINUS, HID_KEY_TAB, HID_KEY_O, HID_KEY_F, HID_KEY_UP_ARROW, HID_KEY_V},               \
            {HID_KEY_F3, HID_KEY_0, HID_KEY_W, HID_KEY_I, HID_KEY_D, HID_KEY_SHIFT_RIGHT, HID_KEY_C},                  \
            {HID_KEY_F2, HID_KEY_9, HID_KEY_Q, HID_KEY_U, HID_KEY_S, HID_KEY_SLASH, HID_KEY_X},                        \
            {HID_KEY_F1, HID_KEY_8, HID_KEY_E, HID_KEY_Y, HID_KEY_A, HID_KEY_PERIOD, HID_KEY_Z},                       \
        {                                                                                                              \
            HID_KEY_ESC, HID_KEY_7, HID_KEY_R, HID_KEY_T, HID_KEY_CAPS_LOCK, HID_KEY_COMMA, HID_KEY_SHIFT_LEFT         \
        }                                                                                                              \
    }
