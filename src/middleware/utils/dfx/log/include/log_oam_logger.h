...
#define oml_bgh_log_print0(mid, lvl, fmt) \
    log_event_print0(log_head_press(OM_BGH), para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__))
#define oml_bgh_log_print1(mid, lvl, fmt, p1) \
    log_event_print1(log_head_press(OM_BGH), para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1))
#define oml_bgh_log_print2(mid, lvl, fmt, p1, p2) \
    log_event_print2(log_head_press(OM_BGH), para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), \
                     (uint32_t)(p1), (uint32_t)(p2))
#define oml_bgh_log_print3(mid, lvl, fmt, p1, p2, p3) \
    log_event_print3(log_head_press(OM_BGH), para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), \
                     (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3))
#define oml_bgh_log_print4(mid, lvl, fmt, p1, p2, p3, p4) \
    log_event_print4(log_head_press(OM_BGH), para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), \
                    (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4))
#define oml_bgh_log_print5(mid, lvl, fmt, num, arg...) \
    log_event_print_alterable_para_press(log_head_press(OM_BGH), \
                                         para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), num, ##arg)
#define oml_bgh_log_print6(mid, lvl, fmt, num, arg...) \
    log_event_print_alterable_para_press(log_head_press(OM_BGH), \
                                         para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), num, ##arg)
#define oml_bgh_log_alter(mid, lognum, lvl, fmt, num, arg...) \
    log_event_print_alterable_para_press(log_head_press(OM_BGH), \
                                         para_press(LOG_BGHMODULE, lvl, THIS_FILE_ID, __LINE__), num, ##arg)
#endif
...
#define oml_alg_log_print0(mid, lognum, lvl, fmt) do { \
    log_event_print0(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__)); \
    log_other_print0(mid, lvl, fmt); \
} while (0)
#define oml_alg_log_print1(mid, lognum, lvl, fmt, p1) do { \
    log_event_print1(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1)); \
    log_other_print1(mid, lvl, fmt, (uint32_t)(p1)); \
} while (0)
#define oml_alg_log_print2(mid, lognum, lvl, fmt, p1, p2) do {    \
    log_event_print2(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), \
                     (uint32_t)(p1), (uint32_t)(p2));    \
    log_other_print2(mid, lvl, fmt, (uint32_t)(p1), (uint32_t)(p2)); \
} while (0)
#define oml_alg_log_print3(mid, lognum, lvl, fmt, p1, p2, p3) do { \
    log_event_print3(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), \
                     (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3)); \
    log_other_print3(mid, lvl, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3)); \
} while (0)
#define oml_alg_log_print4(mid, lognum, lvl, fmt, p1, p2, p3, p4) do { \
    log_event_print4(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), \
                     (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4));    \
    log_other_print4(mid, lvl, fmt, (uint32_t)(p1), (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4)); \
} while (0)
...
#define oml_alg_log_print0(mid, lognum, lvl, fmt) \
    log_event_print0(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__))
#define oml_alg_log_print1(mid, lognum, lvl, fmt, p1) \
    log_event_print1(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1))
#define oml_alg_log_print2(mid, lognum, lvl, fmt, p1, p2) \
    log_event_print2(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2))
#define oml_alg_log_print3(mid, lognum, lvl, fmt, p1, p2, p3) \
    log_event_print3(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2), (uint32_t)(p3))
#define oml_alg_log_print4(mid, lognum, lvl, fmt, p1, p2, p3, p4) \
    log_event_print4(log_head_press(OM_ALG), para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), (uint32_t)(p1), \
                     (uint32_t)(p2), (uint32_t)(p3), (uint32_t)(p4))
...
#define oml_alg_log_print_alter(mid, lognum, lvl, fmt, num, arg...) \
    log_event_print_alterable_para_press(log_head_press(OM_ALG), \
                                         para_press(LOG_ALGMODULE, lvl, THIS_FILE_ID, __LINE__), num, ##arg)
#define alg_log_alter(mid, lognum, lvl, fmt, num, arg...) \
    oml_alg_log_print_alter(LOG_ALGMODULE, lognum, lvl, fmt, num, ##arg)
...
#define oml_pf_log_print1(mid, lognum, lvl, fmt, p1) \
    BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, ONE_ARG, p1)
#define oml_pf_log_print2(mid, lognum, lvl, fmt, p1, p2) \
    BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, TWO_ARG, p1, p2)
#define oml_pf_log_print3(mid, lognum, lvl, fmt, p1, p2, p3) \
...
#define oml_alg_log_print0(mid, lognum, lvl, fmt) BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, NO_ARG)
#define oml_alg_log_print1(mid, lognum, lvl, fmt, p1) \
    BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, ONE_ARG, p1)
#define oml_alg_log_print2(mid, lognum, lvl, fmt, p1, p2) \
    BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, TWO_ARG, p1, p2)
...
#define oml_alg_log_print_alter(mid, lognum, lvl, fmt, num, arg...) \
    BASE_PRINT(CONNECT(mid, ((lognum) & LOG_NUM_MASK)), lvl, fmt, num, ##arg)
#define alg_log_alter(mid, lognum, lvl, fmt, num, arg...) oml_alg_log_print_alter(mid, lognum, lvl, fmt, num, ##arg)
#define alg_write_fifo_log_alter(mid, lognum, lvl, fmt, num, arg...) \
        oml_alg_log_print_alter(mid, lognum, lvl, fmt, num, ##arg)
