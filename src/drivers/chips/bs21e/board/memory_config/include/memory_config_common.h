...
#define FLASHBOOTA_REGION_LENGTH  (FLASHBOOT_A_IMAGE_LEN)
#define FLASHBOOTB_REGION_LENGTH  (FLASHBOOT_B_IMAGE_LEN)
...
/* FOTA Region LENGTH */
#define FOTA_DATA_LENGTH        FOTA_IMAGE_LEN
#define FOTA_DATA_OFFSET        FOTA_IMAGE_OFFSET
...
#else /* CONFIG_ULTRA_DEEP_SLEEP_ENABLE */
