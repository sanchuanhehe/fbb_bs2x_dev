...
errcode_t uapi_sfc_lock_protect(sfc_flash_protect_region_t region)
{
    ...
    return sfc_port_lock_write_protect(region);
}
...
errcode_t uapi_sfc_unlock_protect(void)
{
    ...
    return sfc_port_unlock_write_protect();
}
#endif