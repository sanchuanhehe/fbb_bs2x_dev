...
uint8_t g_pm_device_name_value[32] = {'B', 'S', '2', '1', '-', 'p', 'm', '-', 'd', 'e', 'm', 'o', '\0'};
uint8_t g_pm_device_name_len = 12;
    ...
    gap_ble_pair_state_t pair_state, gap_ble_disc_reason_t disc_reason)
{
    ...
    if (conn_state == GAP_BLE_STATE_CONNECTED) {
        ...
        pm_ble_set_state_trans_duration();
#endif
...
static errcode_t ble_uuid_server_register_callbacks(void)
{
    ...
    dev_cb.ble_enable_cb = ble_uuid_server_enable_cbk;
