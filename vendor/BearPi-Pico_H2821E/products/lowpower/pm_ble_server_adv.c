 ...
 *
 * Description: Provides ble server adv demo API \n
 *
 * History: \n
...
static uint8_t g_local_name[ NAME_MAX_LENGTH] = { 'B', 'S', '2', '1', '-', 'p', 'm', '-', 'd', 'e', 'm', 'o', '\0'};
...
uint8_t pm_ble_set_adv_data(void)
{
    errcode_t n_ret = 0;
