...
#define UART_TRANSFER_SIZE 11
#define CONFIG_UART1_TXD_PIN 15
#define CONFIG_UART1_RXD_PIN 16
#define CONFIG_UART1_RXPIN_MODE 16
#define CONFIG_UART1_TXPIN_MODE 17
#define CONFIG_UART1_BUS_ID 0
...
{
    uapi_pin_set_mode(CONFIG_UART1_TXD_PIN, CONFIG_UART1_TXPIN_MODE);
    uapi_pin_set_mode(CONFIG_UART1_RXD_PIN, CONFIG_UART1_RXPIN_MODE);
}
