...
{
    if (write_cb_para->length == strlen("LED_ON") && write_cb_para->value[0] == 'L' && write_cb_para->value[DATA_LEN1] == 'E' &&
        write_cb_para->value[DATA_LEN2] == 'D' && write_cb_para->value[DATA_LEN3] == '_' && write_cb_para->value[DATA_LEN4] == 'O' &&
        write_cb_para->value[DATA_LEN5] == 'N') {
        PRINT("[SLE Server] client main board led is on.\r\n");
    }

    if (write_cb_para->length == strlen("LED_OFF") && write_cb_para->value[0] == 'L' &&
        write_cb_para->value[DATA_LEN1] == 'E' && write_cb_para->value[DATA_LEN2] == 'D' && write_cb_para->value[DATA_LEN3] == '_' &&
        write_cb_para->value[DATA_LEN4] == 'O' && write_cb_para->value[DATA_LEN5] == 'F' && write_cb_para->value[DATA_LEN6] == 'F') {
