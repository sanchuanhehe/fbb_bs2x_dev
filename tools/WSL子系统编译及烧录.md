...
- 在新终端中输入`git clone https://gitee.com/HiSpark/fbb_bs2x.git`指令下载代码，等待下载完成。
  ...
  ![image-20250424152550246](../docs/pic/tools/image-20250424152550246.png)
...
- 打开烧录工具，选择对应的串口,打开烧录工具,点开Option选项,选择对应的目标即可,WS63E与WS63属于同一款系列，选择WS63即可。
  ...
  ![image-20250424153114047](../docs/pic/tools/image-20250424153114047.png)
...
- 烧录完成结果如下：
  ...
  ![image-20250424153039686](../docs/pic/tools/image-20250424153039686.png)

  （4） 打开串口工具,波特率选择115200,上电后可以看到相关的串口打印。（用户百度下载串口工具即可，例如：sscom、xshell）

  ![image-20250422185051383](../docs/pic/tools/image-20250422185051383.png)
